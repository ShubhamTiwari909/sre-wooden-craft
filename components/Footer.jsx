  ...
  return (
    <>
      <footer className="w-full text-sky-500">
        <div className="pt-16 pb-12 text-sm border-t border-sky-200 bg-sky-800">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:grid-cols-6 lg:grid-cols-12">
              <nav
                className="md:col-span-2 md:col-span-4 lg:col-span-3 mb-6 md:mb-0"
                aria-labelledby="footer-product-light"
              >
                <h3
                  className="mb-6 text-base font-medium text-sky-100"
                ...
                <ul className="space-y-4">
                  <li className="leading-6">
                    <a
                      href="#"
                      className="text-sky-200 inline-block transition-colors duration-300 hover:text-sky-600 focus:text-sky-100"
                    >
                      Features
                    </a>
                  </li>
              ...
              <nav
                className="md:col-span-2 md:col-span-4 lg:col-span-3"
        ...
        {/*  <!-- Sub Footer --> */}
        <div className="py-4 text-sm border-t border-sky-200/40 bg-sky-100/80">
          <div className="container px-6 mx-auto">
              ...
              >
                ...
                <ul className="flex items-center justify-end gap-4">
                  <li>
                    <a
                      href="#"
                      className="text-sky-600 inline-block transition-colors duration-300 hover:text-sky-700 focus:text-sky-100"
                    >
                      <svg
